...
{
    /// <summary>
    /// PerformanceIndicatorWeekData
    /// </summary>
    [DataContract]
    public partial class PerformanceIndicatorWeekData :  IEquatable<PerformanceIndicatorWeekData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PerformanceIndicatorWeekData" /> class.
        /// </summary>
        /// <param name="SelectedYear">reflection (default to 0).</param>
        /// <param name="SelectedWeek">reflection (default to 0).</param>
        ...
        public PerformanceIndicatorWeekData(int? SelectedYear = null, int? SelectedWeek = null, int? KeyPerformanceIndicatorID = null, double? Actual = null, double? Budget = null, double? Forecast = null, double? Goal = null, string Comment = null, CorporateStructureLink CorporateStructureLink = null, int? ActualSourceID = null, int? BudgetSourceID = null, int? ID = null)
        {
            ...
            // use default value if no "SelectedWeek" provided
        ...
        /// </summary>
        /// <value>reflection</value>
        [DataMember(Name="SelectedWeek", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PerformanceIndicatorWeekData {\n");
            sb.Append("  SelectedYear: ").Append(SelectedYear).Append("\n");
            sb.Append("  SelectedWeek: ").Append(SelectedWeek).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PerformanceIndicatorWeekData);
        }

        /// <summary>
        /// Returns true if PerformanceIndicatorWeekData instances are equal
        /// </summary>
        /// <param name="other">Instance of PerformanceIndicatorWeekData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerformanceIndicatorWeekData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.SelectedWeek == other.SelectedWeek ||
                    this.SelectedWeek != null &&
                    this.SelectedWeek.Equals(other.SelectedWeek)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SelectedWeek != null)
                    hash = hash * 59 + this.SelectedWeek.GetHashCode();
