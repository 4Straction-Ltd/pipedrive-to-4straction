...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserCompanyAccess :  IEquatable<UserCompanyAccess>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserCompanyAccess" /> class.
        /// </summary>
        ...
        public UserCompanyAccess(int? CompanyID = null, int? UserID = null, DateTime? Added = null, int? IsUserAdministrator = null, int? SystemUserTypeID = null, int? ProfileID = null, int? ID = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserCompanyAccess {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserCompanyAccess);
        }

        /// <summary>
        /// Returns true if UserCompanyAccess instances are equal
        /// </summary>
        /// <param name="other">Instance of UserCompanyAccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserCompanyAccess other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
